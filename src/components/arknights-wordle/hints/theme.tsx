...
const moonIcon = () => (
  <svg className="swap-off h-6 w-6 fill-current fixed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export default function Theme() {
  ...
  return (
    <label className="swap swap-rotate justify-start custom-dropdown-items">
      ...
      {sunIcon()}
      {moonIcon()}
      <span className="ml-2"><span className="font-bold">Switch</span> to {darkMode ? "LIGHT" : "DARK"} mode</span>
    </label>
  );
}
